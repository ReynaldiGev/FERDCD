...
face_classifier = cv2.CascadeClassifier(r'D:\coba2\FERDCD\haarcascade_frontalface_default.xml')
json_file = open('model_json.json', 'r')
loaded_model_json = json_file.read()
json_file.close()
classifier =tf.keras.models.model_from_json(loaded_model_json)
classifier.load_weights('D:/coba2/FERDCD/model_weight.h5')
emotion_labels = ['Angry','Happy','Neutral', 'Sad', 'Surprise']



model=tf.keras.models.model_from_json(loaded_model_json)
model.load_weights('D:/coba2/FERDCD/model_weight.h5')
faceDetect=cv2.CascadeClassifier(r'D:\coba2\FERDCD\haarcascade_frontalface_default.xml')
...
main_image = Image.open('D:/coba2/FERDCD/img/dl.png')
